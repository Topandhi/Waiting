...
<body style="background-image: url(Future.png');background-position: top;background-repeat: repeat;padding:0px;">
    ...
    <!-- <div style="display:flex;flex-direction:row;justify-content:flex-end;">
        ...
        <script>
            ...
            const specificDate = new Date('2024-03-30T08:00:00');
